...
def detect_injection(user_input: str) -> bool:
    ...
    INJECTION_PATTERNS = [
        ...
        r"you\s+are\s+now\s+(?:an?\s+)?(?:dan|unrestricted|unfiltered|jailbroken)",
        r"system\s+prompt",
    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("I cannot process that request. I'm here to help with banking questions only.")
